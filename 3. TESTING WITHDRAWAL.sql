...
SELECT * FROM Customer_Transactions WHERE SenderAcc = @john_doe_acc AND Amount = 50.00 AND Type = 'Withdraw';
...
SELECT * FROM Customer_Transactions WHERE SenderAcc = @john_doe_acc AND Amount = 100000.00 AND Type = 'Withdraw';
...
SELECT * FROM Customer_Transactions WHERE SenderAcc = @jane_smith_acc AND Amount = 50001.00 AND Type = 'Withdraw';
...
SELECT 'High Value Transactions (High Value Withdraw):' AS Report;
SELECT * FROM High_Value_Transactions WHERE SenderAcc = @jane_smith_acc AND Amount = 50001.00 AND Type = 'Withdraw';